...
const S3_OUTPUTS_BUCKET = process.env.S3_OUTPUTS_BUCKET || "adira-outputs";
...
async function processJob(job) {
  ...
  // WhatsApp requires a direct public URL
  const downloadUrl = `https://${S3_OUTPUTS_BUCKET}.s3.ap-south-1.amazonaws.com/${s3Key}`;
...
${plan !== "trial" ? '_"send word file"_ for editable version' : ""}
